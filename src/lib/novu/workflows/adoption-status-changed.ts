...
import { z } from 'zod';
import { createAdoptionStatusEmail } from '../emailTemplates';

export const adoptionStatusChanged = workflow('adoption-status-changed', async ({ step, payload }: { step: any; payload: any }) => {
