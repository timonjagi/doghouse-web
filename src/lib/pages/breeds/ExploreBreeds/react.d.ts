...
> = SliderOptions<
  WebOptions<KeenSliderOptions<O, P, H>> &
    ...
    DragAnimationOptions<
      DRAG_ANIMATION_MODE_SNAP | DRAG_ANIMATION_MODE_FREE | DRAG_ANIMATION_MODE_FREE_SNAP
    >
> & {
  [key in Exclude<
    H | KeenSliderHooks,
...
export declare type KeenSliderPlugin<
  ...
  P = {},
  H extends string = KeenSliderHooks,
> = SliderPlugin<KeenSliderOptions<O, P, H>, KeenSliderInstance<O, P, H>, KeenSliderHooks | H>
...
export declare interface WebOptions<O> {
  ...
  selector?:
    | string
    | ((container: HTMLElement) => HTMLElement[] | NodeList | HTMLCollection | null)
    | null
  slides?:
