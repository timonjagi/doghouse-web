import { Heading, HStack, Icon, Stack, StackProps, Text, useBreakpointValue, useColorModeValue } from '@chakra-ui/react'
  ...
  return (
    ...
    <Stack flex="1" spacing="6">
      <HStack justifyContent="space-between">
        <Stack >
          <Heading size={useBreakpointValue({ base: "sm", md: "md" })} textTransform="capitalize">
            {breed.name}
          </Heading>
        </Stack>
        <Share />
        ...
        {breed.traits &&
          breed.traits.map((group) => (
            <HStack
              ...
              alignItems='center'
            >
              <Text fontSize={{ base: 'sm', md: 'md' }} color={color}>{group.name}</Text>
