...
const Layout = ({ children }: LayoutProps) => {
  ...
  const dashboardRoutes = [
    ...
    { path: "/dashboard/explore/breeds", layout: 'dashboard' },
    { path: "/dashboard/explore/breeds/[id]", layout: 'dashboard' },
    { path: "/dashboard/explore/breeders", layout: 'dashboard' },
    { path: "/dashboard/explore/breeders/[id]", layout: 'dashboard' },
    { path: "/dashboard/explore/listings", layout: 'dashboard' },
    { path: "/dashboard/explore/listings/[id]", layout: 'dashboard' },
